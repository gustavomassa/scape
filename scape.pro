...
unrealRootPath=/mnt/ssd/Epic Games/UE_LINUX
scapeRootPath=/mnt/ssd/Projects/Unreal/scape

gameProjectFile=/mnt/ssd/Projects/Unreal/scape/scape.uproject
...
include(scapeSource.pri)
include(scapeHeader.pri)
include(scapeConfig.pri)
include(scapeIncludes.pri)
include(scapeDefines.pri)
...
scape-Linux-Debug.commands = $$build scape Linux Debug  -project="\"$$gameProjectFile\"" $$args
scape-Linux-DebugGame.commands = $$build scape Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
scape-Linux-Shipping.commands = $$build scape Linux Shipping  -project="\"$$gameProjectFile\"" $$args
scape-Linux-Test.commands = $$build scape Linux Test  -project="\"$$gameProjectFile\"" $$args
scape.commands = $$build scape Linux Development  -project="\"$$gameProjectFile\"" $$args

scapeEditor-Linux-Debug.commands = $$build scapeEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
scapeEditor-Linux-DebugGame.commands = $$build scapeEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
scapeEditor-Linux-Shipping.commands = $$build scapeEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
scapeEditor-Linux-Test.commands = $$build scapeEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
scapeEditor.commands = $$build scapeEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	UE4Server \
	scape-Linux-Debug \
	scape-Linux-DebugGame \
	scape-Linux-Shipping \
	scape-Linux-Test \
	scape \
	scapeEditor-Linux-Debug \
	scapeEditor-Linux-DebugGame \
	scapeEditor-Linux-Shipping \
	scapeEditor-Linux-Test \
	scapeEditor \
