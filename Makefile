...
scape-Linux-Debug:
	 $(PROJECTBUILD) scape Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

scape-Linux-DebugGame:
	 $(PROJECTBUILD) scape Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

scape-Linux-Shipping:
	 $(PROJECTBUILD) scape Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

scape-Linux-Test:
	 $(PROJECTBUILD) scape Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

scape:
	 $(PROJECTBUILD) scape Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

scapeEditor-Linux-Debug:
	 $(PROJECTBUILD) scapeEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

scapeEditor-Linux-DebugGame:
	 $(PROJECTBUILD) scapeEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

scapeEditor-Linux-Shipping:
	 $(PROJECTBUILD) scapeEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

scapeEditor-Linux-Test:
	 $(PROJECTBUILD) scapeEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

scapeEditor:
	 $(PROJECTBUILD) scapeEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
